# Ansys Mechanical — Benchmark Result Recorder

`record-benchmark.sh` in this folder records **one** Ansys Mechanical benchmark
run (structural FEA) into the shared AI-Powered HPC dataset (Amazon DynamoDB),
...
See the Mechanical-specific metrics (model size / DOF, solver and analysis type)
