# Ansys CFX — Benchmark Result Recorder

`record-benchmark.sh` in this folder records **one** Ansys CFX benchmark run
...
See the CFX-specific metrics (mesh size, solver/analysis characteristics) with
