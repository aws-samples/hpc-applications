...
#############################################################
# Build HPL 2.3 with Intel MPI + AMD AOCL BLIS + AOCC
...
#
# We wrap mpicc to use AOCC's clang as the underlying
# compiler via I_MPI_CC, giving us znver5 codegen while
# still linking against Intel MPI.
#############################################################

HPL_VERSION="2.3"
HPL_URL="https://www.netlib.org/benchmark/hpl/hpl-${HPL_VERSION}.tar.gz"
INSTALL_DIR="/fsx/HPL-IntelMPI"
...
# Tell Intel MPI's mpicc to use AOCC clang
